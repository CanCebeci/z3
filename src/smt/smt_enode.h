...
namespace smt {
    ...
    */
    class enode {
        ...
        bool                m_is_cgr;        //!< True if the enode is a congruence class representative.
        bool                m_is_demoted;    //!< True if the enode was demoted from being a congruence class representative.
