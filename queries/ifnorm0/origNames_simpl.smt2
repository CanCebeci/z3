...
(let ((anon15_Else_correct  
    (=> (and (and (and (|_module.__default.NestedIf#canCall| |g#0@@5| |a#0@@5| |b#0@@5| |x#0@@5| |y#0@@5|) (|_module.__default.FVs#canCall| (_module.__default.NestedIf |g#0@@5| |a#0@@5| |b#0@@5| |x#0@@5| |y#0@@5|))) (and (and (and (and (|_module.__default.FVs#canCall| |g#0@@5|) (|_module.__default.FVs#canCall| |a#0@@5|)) (|_module.__default.FVs#canCall| |b#0@@5|)) (|_module.__default.FVs#canCall| |x#0@@5|)) (|_module.__default.FVs#canCall| |y#0@@5|))) (|Set#Equal| (_module.__default.FVs ($LS $LZ) (_module.__default.NestedIf |g#0@@5| |a#0@@5| |b#0@@5| |x#0@@5| |y#0@@5|)) (|Set#Union| (|Set#Union| (|Set#Union| (|Set#Union| (_module.__default.FVs ($LS $LZ) |g#0@@5|) (_module.__default.FVs ($LS $LZ) |a#0@@5|)) (_module.__default.FVs ($LS $LZ) |b#0@@5|)) (_module.__default.FVs ($LS $LZ) |x#0@@5|)) (_module.__default.FVs ($LS $LZ) |y#0@@5|)))) 
        
        (and (and (and (and (and 
            (=> (= (ControlFlow 0 20) 8) anon16_Then_correct) 
            (=> (= (ControlFlow 0 20) 10) anon17_Then_correct)) 
            (=> (= (ControlFlow 0 20) 12) anon18_Then_correct)) 
            (=> (= (ControlFlow 0 20) 14) anon19_Then_correct)) 
            (=> (= (ControlFlow 0 20) 16) anon20_Then_correct)) 
            (=> (= (ControlFlow 0 20) 19) anon20_Else_correct)))))
...
(let ((anon13_Then_correct  

    (=> ($IsAlloc DatatypeTypeType |g#0@@5| Tclass._module.Expr $Heap@0) 
        (=> (and (and (and (and ($IsAlloc DatatypeTypeType |a#0@@5| Tclass._module.Expr $Heap@0) ($IsAlloc DatatypeTypeType |b#0@@5| Tclass._module.Expr $Heap@0)) (and ($IsAlloc DatatypeTypeType |x#0@@5| Tclass._module.Expr $Heap@0) ($IsAlloc DatatypeTypeType |y#0@@5| Tclass._module.Expr $Heap@0))) (and (and (|_module.__default.NestedIf#canCall| |g#0@@5| |a#0@@5| |b#0@@5| |x#0@@5| |y#0@@5|) (= |##e#0_2_0@0| (_module.__default.NestedIf |g#0@@5| |a#0@@5| |b#0@@5| |x#0@@5| |y#0@@5|))) (and ($IsAlloc DatatypeTypeType |##e#0_2_0@0| Tclass._module.Expr $Heap@0) (|_module.__default.FVs#canCall| (_module.__default.NestedIf |g#0@@5| |a#0@@5| |b#0@@5| |x#0@@5| |y#0@@5|))))) (and (and (and (|_module.__default.NestedIf#canCall| |g#0@@5| |a#0@@5| |b#0@@5| |x#0@@5| |y#0@@5|) (|_module.__default.FVs#canCall| (_module.__default.NestedIf |g#0@@5| |a#0@@5| |b#0@@5| |x#0@@5| |y#0@@5|))) (= |##e#0_2_1@0| (|#_module.Expr.If| (|#_module.Expr.If| |g#0@@5| |a#0@@5| |b#0@@5|) |x#0@@5| |y#0@@5|))) (and (and ($IsAlloc DatatypeTypeType |##e#0_2_1@0| Tclass._module.Expr $Heap@0) (|_module.__default.FVs#canCall| (|#_module.Expr.If| (|#_module.Expr.If| |g#0@@5| |a#0@@5| |b#0@@5|) |x#0@@5| |y#0@@5|))) (and (|_module.__default.FVs#canCall| (|#_module.Expr.If| (|#_module.Expr.If| |g#0@@5| |a#0@@5| |b#0@@5|) |x#0@@5| |y#0@@5|)) (= (ControlFlow 0 3) (- 0 2)))))) 
        (|Set#Equal| (_module.__default.FVs ($LS ($LS $LZ)) (_module.__default.NestedIf |g#0@@5| |a#0@@5| |b#0@@5| |x#0@@5| |y#0@@5|)) 
            (_module.__default.FVs ($LS ($LS $LZ)) (|#_module.Expr.If| (|#_module.Expr.If| |g#0@@5| |a#0@@5| |b#0@@5|) |x#0@@5| |y#0@@5|)))))))
(let ((anon12_Then_correct true))

(let ((anon0_correct  
(=> (and (= $_ModifiesFrame@0 (|lambda#0| null $Heap alloc false)) (|$IsA#_module.Expr| |g#0@@5|)) 
(=> (and (and (and (|$IsA#_module.Expr| |a#0@@5|) (|$IsA#_module.Expr| |b#0@@5|)) (and (|$IsA#_module.Expr| |x#0@@5|) (|$IsA#_module.Expr| |y#0@@5|))) (and (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0)) (and (= $Heap $Heap@0) 
        (forall ((|$ih#g0#0| T@U) (|$ih#a0#0| T@U) (|$ih#b0#0| T@U) (|$ih#x0#0| T@U) (|$ih#y0#0| T@U) ) 
        (!  (=> (and (and (and (and (and (and 
            ($Is DatatypeTypeType |$ih#g0#0| Tclass._module.Expr) ($Is DatatypeTypeType |$ih#a0#0| Tclass._module.Expr)) 
            ($Is DatatypeTypeType |$ih#b0#0| Tclass._module.Expr)) ($Is DatatypeTypeType |$ih#x0#0| Tclass._module.Expr)) 
            ($Is DatatypeTypeType |$ih#y0#0| Tclass._module.Expr)) (U_2_bool (Lit boolType (bool_2_U true)))) 
            
            (or (< (DtRank |$ih#g0#0|) (DtRank |g#0@@5|)) 
                (and (= (DtRank |$ih#g0#0|) (DtRank |g#0@@5|)) 
                    (or (< (DtRank |$ih#a0#0|) (DtRank |a#0@@5|)) 
                        (and (= (DtRank |$ih#a0#0|) (DtRank |a#0@@5|)) 
                            (or (< (DtRank |$ih#b0#0|) (DtRank |b#0@@5|)) 
                                (and (= (DtRank |$ih#b0#0|) (DtRank |b#0@@5|)) 
                                    (or (< (DtRank |$ih#x0#0|) (DtRank |x#0@@5|)) 
                                        (and (= (DtRank |$ih#x0#0|) (DtRank |x#0@@5|)) 
                                                (< (DtRank |$ih#y0#0|) (DtRank |y#0@@5|))))))))))) 
            ...
            (and (and (and (and 
                ...
                (|Set#Equal| 
                    (_module.__default.FVs ($LS $LZ) 
                        (_module.__default.UnnestedIf |$ih#g0#0| |$ih#a0#0| |$ih#b0#0| |$ih#x0#0| |$ih#y0#0|)) 
                        
                    (|Set#Union| (|Set#Union| (|Set#Union| (|Set#Union| (_module.__default.FVs ($LS $LZ) |$ih#g0#0|) (_module.__default.FVs ($LS $LZ) |$ih#a0#0|)) (_module.__default.FVs ($LS $LZ) |$ih#b0#0|)) (_module.__default.FVs ($LS $LZ) |$ih#x0#0|)) (_module.__default.FVs ($LS $LZ) |$ih#y0#0|)))))
    ...
    ; IH is true, one of these is false.
    (and (and (and (and 
        ; (=> (= (ControlFlow 0 21) 1) anon12_Then_correct) 
        (=> (= (ControlFlow 0 21) 3) anon13_Then_correct)
        ) 
        ; (=> (= (ControlFlow 0 21) 5) anon14_Then_correct)
        ) 
        ; (=> (= (ControlFlow 0 21) 7) anon15_Then_correct)
        ) 
